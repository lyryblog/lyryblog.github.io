...
UID_LIST = ['1596163', '473837611', '1131457022', '433587902', '50329118']
# 投币UP主的ID号,如果不修改，默认将用上面这个列表里的,可以选择自己喜欢的UP主
# 获取UID的方法见 https://www.dujin.org/20063.html
# 缙哥哥 新华网 人民日报 央视频  英雄联盟赛事

COOKIE_LIST = ['''Cookie填这里''']
# Bilibili 的 COOKIE 获取的方法见 https://www.dujin.org/20063.html
